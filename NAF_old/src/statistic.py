...
class Statistic(object):
  def __init__(self, sess, env_name, model_dir, variables, max_update_per_step, max_to_keep=20):
    ...
    #self.saver = tf.train.Saver(variables + [self.t_op])
  ...
  def save_model(self, t):
    ...
    folder_name = "checkpoints/awake_test_1/"
    ...
    self.saver.save(self.sess,folder_name+"/test.ckpt")#, global_step=t)
  ...
  def load_model(self):
    ...
    if ckpt and ckpt.model_checkpoint_path:
      ...
      logger.info("Load SUCCESS: " )#% fname)
    else:
